        ...
        <div className='bg-[#e7e7e5]'>
          <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
            ...
            <ul className='hidden md:flex cursor-pointer'>
              <a href='/home'><li className='p-4 text-blue-500'>Home</li></a> 
              <a href='/report'><li className='p-4 text-blue-500'>Create Report</li></a>
              <a href='/contact' className='p-4 text-blue-500'>About</a>
              <a href='/contact'><li className='p-4 text-blue-500'>Contact</li></a> 
              <a href='/admin'><li className='p-4 text-blue-500'>Admin</li></a>
              <a href='/signup'><li className='p-4 px-12 font-bold text-blue-500'>Sign Up/Sign In</li></a>
